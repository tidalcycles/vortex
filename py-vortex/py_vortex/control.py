...
for cls, name in ([(S,"S"),(F,"F"),(I,"I")]):
    cls_controls = [x[1] for x in filter(lambda x: x[0] == name, generic_params)]
    controls.append((cls, name, cls_controls))
